{
    'variables': {
        ...
        'LIN_ALG_INCLUDE%': 'E:/Develop/qminer/src/glib/base/',
        'LIN_EIGEN_INCLUDE%': 'E:/Develop/qminer/src/third_party/eigen/',
    ...
    'targets': [
        {
            # ZeroValueAnomaly
            'target_name': 'ZeroValueAnomaly',
            'type': 'executable',
            'sources': [
                'ZeroValueAnomaly/main.cpp',
